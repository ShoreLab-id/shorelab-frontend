...
const UserHook = () => {
  return (
    <main className="bg-teal-secondary bg-[url('/assets/topography.webp')] w-full flex justify-center py-20">
      <div className="w-[80%] max-w-[1300px] rounded-xl flex flex-col items-center justify-center">
        <h1
          className={oxygen + "text-[36px] text-white text-center text-pretty"}
        >
        ...
        <div className={oxygen + "grid grid-cols-4 pt-8 gap-16"}>
          ...
          <div className="text-center text-white max-w-56 flex flex-col gap-4">
            <p className="text-[48px] leading-none">
              <b>43.22+ </b>
              <span className="text-[27px]">Ha</span>
            </p>
          ...
          <div className="text-center text-white max-w-56 flex flex-col gap-4">
            <p className="text-[48px] leading-none">
              <b>100.2+ </b>
              <span className="text-[27px]">Kg</span>
            </p>
            <p className="text-[21px] leading-snug">
