...
const AboutSection = () => {
  return (
    <div className="w-full flex justify-center py-20 bg-red-500/25">
      <div className="w-[90%] max-w-[1300px] h-full bg-blue-500/25">
        <div className="flex gap-[130px] items-center">
          ...
          <div>
            <div about="section-heading" className="mb-12 bg-red-500/25">
              <h2
                className={
                  poppins +
              ...
              <h1
                className={
                  poppins +
                  "text-[48px] font-semibold text-primary-dark leading-tight"
                }
              >
                What is ShoreLab Academy?
              </h1>
            </div>
            <p
