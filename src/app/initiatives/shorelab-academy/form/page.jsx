  ...
  return (
    <div className='flex flex-col py-3'>
      ...
      <input
        ...
        type={type}
        className={oxygen + "text-[20px] py-3 px-6 rounded-lg border-2 border-teal-secondary transition-colors focus:border-foam-tertiary focus:outline-none text-primary-dark"}
      />
    ...
    <div className="w-full flex justify-center py-20">
      <div className="w-[90%] max-w-[1300px] h-full flex flex-col gap-8">
        <div className='flex flex-col gap-2'>
          <h2 className={poppins + "text-[27px] font-semibold text-teal-secondary text-center"}>
            REGISTRATION FORM
          </h2>
          <h1 className={poppins + "text-[84px] font-semibold text-primary-dark text-center"}>
            ShoreLab Academy
          </h1>
        </div>
        <div>
          <p className={oxygen + "text-[36px] text-primary-dark"}>Thank you for your interest in ShoreLab Academy. Kindly fill in your details, and we will get in touch with you soon with more information. Thank you!</p>
          <form className='pt-10'>
            <TextInputComponent placeholder="Registered Email" label="Email" type="email">
              Enter you email used for login to ShoreLab. Don&apos;t have any? <a href="/register" className='font-semibold underline'>Create Account</a>.
            </TextInputComponent>
            <TextInputComponent
              label="Phone"
              type="number"
            ...
            >
              Please enter your complete university name. For example: Universitas Gadjah Mada
            </TextInputComponent>
            <TextInputComponent
              label="Student Email"
              type="email"
            ...
            <TextInputComponent
              ...
              >
                Please enter your complete faculty name. For example: Fakultas Teknik
              </TextInputComponent>
            <TextInputComponent
              label="Semester"
              type="number"
